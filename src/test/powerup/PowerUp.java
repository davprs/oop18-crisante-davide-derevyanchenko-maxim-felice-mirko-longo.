...
public class PowerUp {
    ...
    public void testFreeze() {
      ...
      enemy.get(1);
      enemy.get(2);
      final Point2D positionInitial0 = new Point2D(enemy.get(0).getBoundary().getMinX(), enemy.get(0).getBoundary().getMinY());
      final Point2D positionInitial1 = new Point2D(enemy.get(1).getBoundary().getMinX(), enemy.get(1).getBoundary().getMinY());
      final Point2D positionInitial2 = new Point2D(enemy.get(2).getBoundary().getMinX(), enemy.get(2).getBoundary().getMinY());
      freeze.run();
      enemy.get(0).update(POINT2D2);
      enemy.get(1).update(POINT2D2);
      enemy.get(2).update(POINT2D2);
      final Point2D position0 = new Point2D(enemy.get(0).getBoundary().getMinX(), enemy.get(0).getBoundary().getMinY());
      final Point2D position1 = new Point2D(enemy.get(1).getBoundary().getMinX(), enemy.get(1).getBoundary().getMinY());
      final Point2D position2 = new Point2D(enemy.get(2).getBoundary().getMinX(), enemy.get(2).getBoundary().getMinY());
